...
export async function getTodayWellbeing(userId: string) {
...
export async function upsertTodayWellbeing(
  userId: string,
  payload: {
...
export async function logWellbeingIntervention(
  userId: string,
  payload: {
...
export async function getWeeklyWellbeing(userId: string) {
