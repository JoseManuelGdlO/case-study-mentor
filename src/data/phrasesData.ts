...
export const mockPhrases: MotivationalPhrase[] = [
  { id: 'p1', text: 'El éxito en medicina no es cuestión de suerte, es cuestión de preparación.', author: 'ENARM Prep', isActive: true, createdAt: '2024-01-10' },
  ...
  { id: 'p6', text: 'Tu futuro paciente te necesita preparado. Sigue adelante.', author: 'ENARM Prep', isActive: true, createdAt: '2024-03-01' },
