...
export const mockExams: Exam[] = [
  ...
  {
    id: 'exam-4',
    config: { language: 'es', mode: 'simulation', categories: ['Pediatría', 'Cirugía'], subcategories: ['Neonatología', 'Cirugía General'], questionCount: 50 },
    cases: [mockCases[1]],
    answers: Array.from({ length: 35 }, (_, i) => ({ questionId: `sim-q-${i}`, selectedOptionId: `sim-a-${i}`, isCorrect: Math.random() > 0.3 })),
    currentQuestionIndex: 35,
    status: 'in_progress',
    score: null,
    startedAt: '2024-03-26T14:30:00',
    completedAt: null,
    timeSpentSeconds: 4200,
  },
  {
    id: 'exam-5',
    config: { language: 'en', mode: 'study', categories: ['Ginecología y Obstetricia'], subcategories: ['Obstetricia'], questionCount: 30 },
    cases: [mockCases[2]],
    answers: Array.from({ length: 5 }, (_, i) => ({ questionId: `study-q-${i}`, selectedOptionId: `study-a-${i}`, isCorrect: Math.random() > 0.4 })),
    currentQuestionIndex: 5,
    status: 'in_progress',
    score: null,
    startedAt: '2024-03-27T09:15:00',
    completedAt: null,
